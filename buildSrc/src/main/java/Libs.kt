...
object Dependencies {
    ...
    object Compose {
        ...
        private const val accompanist_systemuicontroller = "com.google.accompanist:accompanist-systemuicontroller:${Versions.accompanist}"
        private const val accompanist_pager = "com.google.accompanist:accompanist-pager:${Versions.accompanist}"
        ...
        fun DependencyHandler.apiCompose() {
            ...
            api(compose_hilt)
            api(coil_compose)
            api(accompanist_systemuicontroller)
            api(accompanist_pager)
        }
